...
def plot_avg_auth(cur, user_ids, color):
...
def plot_avg_pagerank(cur, user_ids, color):
...
def plot_avg_elo(cur, conn, user_ids, color):
...
def plot_avg_cau(cur, conn, user_ids, color):
